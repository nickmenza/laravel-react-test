...
@section('title','Print RAW Commands')
...
var wcppGetPrintersTimeoutStep_ms = 500; //0.5 sec
            ...
            <fieldset>
                ...
                <h3>Your settings were saved! Now it's time to <div onclick="javascript:doClientPrint();" class="btn btn-large btn-success">Print</div></h3>
                <br /><br />
            </fieldset>
...
// The $wcpScript was generated by DemoPrintCommandsController@index
